...
export type LicenseRequest_ContentIdentification_WidevinePsshData =
  Message<"license_protocol.LicenseRequest.ContentIdentification.WidevinePsshData"> & {
    /**
